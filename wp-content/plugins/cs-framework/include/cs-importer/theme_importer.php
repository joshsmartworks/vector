            ...
            <form method="post">
                <div class="importer-wrapper container custom-importer">
                    ...
                    if ( is_wp_error( $response ) ) {
                        wp_die( '<h2 class="error">' . __( 'Sorry, It seems that API server is not available. Please, contact theme owner and report this issue.', 'cs_frame' ) . '</h2>' );
                    }
                    ?>
                                    ...
                                    <ul class="job-select-demo">
                                        ...
                                        <li class="menus-chk-wrapper hidden">
                                            <div class="radiobox">
                                                ...
                                                <label for="chk-menus" class="checkbox-data-import-type"><?php _e( 'Menus', 'cs_frame' ); ?></label>
                                            </div>
                                        </li>
