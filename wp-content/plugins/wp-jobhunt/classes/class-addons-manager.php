...
final class JobHunt_Addons_Manager {
    ...
    private function get_addons_data() {
        ...
        if ( $jobhunt_available_addons ) {
            ...
            if ( $jobhunt_available_addons['next_fetch_time'] > current_time('timestamp') ) {
        ...
        if ( empty( $addons_data['addons'] ) ) {
            ...
            if ( is_wp_error( $response ) ) {
                ...
                if ( 'true' == $body['success'] ) {
                    ...
                    $data_for_option = [
                        'next_fetch_time' => current_time('timestamp') + ( isset( $body['fetch_addons_after_seconds'] ) ? intval( $body['fetch_addons_after_seconds'] ) : 0 ),
    ...
    public function action_admin_menu() {
        add_submenu_page(
                'edit.php?post_type=jobs', esc_html__( 'Addons Manager', 'jobhunt' ), esc_html__( 'Addons Manager', 'jobhunt' ), 'manage_options', $this->get_page_slug(), array( $this, 'display_list_page' )
        );
    }
    ...
    public function display_list_page() {
        ...
        <div class="jc-addons-holder">
            <div class="jc-addons-title">
                <h1><?php esc_html_e( 'Addons Manager', 'jobhunt' ); ?></h1>
            ...
            <div class="jc-addons-nav">
                <ul>
                    <li data-filter="*"><a href="#"><?php esc_html_e( 'All', 'jobhunt' ); ?></a></li>
                    <li data-filter=".active"><a href="#"><?php esc_html_e( 'Active', 'jobhunt' ); ?></a></li>
                    <li data-filter=".inactive"><a href="#"><?php esc_html_e( 'Inactive', 'jobhunt' ); ?></a></li>
