...
function extra_user_profile_fields($user) {
    ...
    <table class="form-table">
        <tr>
            <th><label for="specialism"><?php esc_html_e('Specialisms', 'jobhunt'); ?></label></th>
            <td>
                <?php
                ...
                if (!empty($terms)) {
                    ...
                    esc_html_e('There are no specialisms available.', 'jobhunt');
                }
                ?>
            </td>
        </tr>
                    ...
                    <div class="elementhidden">
                        <nav class="admin-navigtion">
                            <ul id="cs-options-tab">
                                ...
                                <?php } ?>
                                <li  <?php echo force_balance_tags($candidate_custom_field_str); ?> class="cs-candidate-fields"><a name="#tab-cvcover-letter" href="javascript:;"><i class="icon-vcard"></i><?php echo esc_html__('CV & Cover Letter', 'jobhunt'); ?> </a></li>
