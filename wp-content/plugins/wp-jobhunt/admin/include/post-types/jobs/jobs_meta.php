...
if ( ! function_exists('create_specialisms_taxonomies') ) {
    ...
    function create_specialisms_taxonomies() {
        register_taxonomy("specialisms", array( "jobs", "employer", "candidate" ), array
            (
            "hierarchical" => true,
            "label" => esc_html__("Specialisms", 'jobhunt'),
            'labels' => array( 'new_item_name' => esc_html__('New Item Specialism', 'jobhunt'),
                'add_new_item' => esc_html__('Add New Specialism', 'jobhunt'),
                'edit_item' => esc_html__('Edit Specialism', 'jobhunt'),
                "singular_name" => esc_html__("Specialism", 'jobhunt')
            ),
            "public" => false,
            'show_ui' => true,
            "show_in_menu" => true,
