					...
					<div class="jobs-content">
						...
						<div class="cs-text">
							...
							<ul>
								...
								<?php if ( $specialisms_values <> '' ) { ?> <li><span><?php esc_html_e( 'Specialism', 'jobhunt' ); ?></span><?php echo esc_html( $specialisms_values ); ?></li><?php } ?>
							...
							<a class="read-more cs-color" href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>"><?php esc_html_e( 'Read more', 'jobhunt' ); ?></a>
							<div class="list-options">
								...
								if ( ! is_user_logged_in() || ! $login_user_is_employer_flag ) {
									...
									?>
									<a class="whishlist_icon shortlist" href="javascript:void(0)"  data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( "Add to Shortlist", "jobhunt" ); ?>" id="<?php echo 'addjobs_to_wishlist' . intval( $post->ID ); ?>" onclick="show_alert_msg('<?php echo esc_html__( "Become a candidate then try again.", "jobhunt" ); ?>')" ><i class="icon-heart-o"></i></a>
										<?php
									}
									echo '</div>';
									?>
