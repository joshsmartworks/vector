                            ...
                            <div class="jobs-content">
                                <div class="cs-media">
                                    ...
                                    <?php } if ( isset($cs_job_featured) and $cs_job_featured == 'yes' || $cs_job_featured == 'on' ) { ?>
                                        <span class="listing-featered"><?php esc_html_e('FEATURED', 'jobhunt'); ?></span><?php } ?>
                                    <div class="wish-list">
                                        <?php
                                ...
                                <div class="cs-text"> <span class="cs-categories cs-color"> <?php echo esc_html($specialisms_values); ?></span>
                                    <div class="cs-post-title">
                                        <h6> <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php echo wp_trim_words(get_the_title($post->ID), 3); ?></a></h6>
                                    </div>
