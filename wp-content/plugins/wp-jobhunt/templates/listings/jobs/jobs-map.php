...
if ($cs_job_map == 'yes') {
    ...
    if (!empty($loop_count->posts)) {
        foreach ($loop_count->posts as $cs_job) {
            $cs_can_latitude = get_post_meta($cs_job->ID, "cs_post_loc_latitude", true);
            $cs_can_longitude = get_post_meta($cs_job->ID, "cs_post_loc_longitude", true);
			
			$cs_job_employer = get_post_meta($cs_job->ID, "cs_job_username", true); //
            ...
            // $cs_jobs_thumb_url = get_post_meta($cs_job->ID, 'user_img', true);
            ...
            //$cs_get_exp_list = get_post_meta($cs_job->ID, 'cs_exp_list_array', true);
            //$cs_exp_titles = get_post_meta($cs_job->ID, 'cs_exp_title_array', true);
            //$cs_exp_from_dates = get_post_meta($cs_job->ID, 'cs_exp_from_date_array', true);
            //$cs_exp_to_dates = get_post_meta($cs_job->ID, 'cs_exp_to_date_array', true);
            //$cs_exp_companys = get_post_meta($cs_job->ID, 'cs_exp_company_array', true);
            ...
            $cs_post_loc_city = get_post_meta($cs_job->ID, 'cs_post_loc_city', true);
            $cs_post_loc_country = get_post_meta($cs_job->ID, 'cs_post_loc_country', true);

            $cs_jobs[] = array(
                'post_id' => $cs_job->ID,
                'post_title' => $cs_job->post_title,
                'permalink' => esc_url(get_permalink($cs_job->ID)),
    ...
    if ($cs_job_map_zoom != '' && $cs_job_map_zoom != '' && $cs_job_map_zoom != '') {
        ...
        //$cs_job_map_style = isset($cs_jobcareer_theme_options['def_map_style']) ? $cs_jobcareer_theme_options['def_map_style'] : '';
        ?>
