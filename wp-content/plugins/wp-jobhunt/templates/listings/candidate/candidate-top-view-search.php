        ...
        <div class="col-lg-3 col-md-3">
            <div class="search-input"> 
                ...
                $cs_opt_array = array(
                    ...
                    'before' => '',
                    'after' => '',
                    'extra_atr' => 'placeholder="' . esc_html__('Enter any keyword', 'jobhunt') . '"',
        ...
        <div class="col-lg-4 col-md-4">
            <div class="search-category">
                <div class="select-holder">
                    <select name="specialisms" id="specialisms" data-placeholder="<?php echo esc_html__('All specialisms', 'jobhunt'); ?>" class="chosen-select">
                        <option value=""><?php esc_html_e('All specialisms', 'jobhunt') ?></option>
                        <?php
