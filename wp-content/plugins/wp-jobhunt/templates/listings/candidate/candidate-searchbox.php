...
<aside class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    <div class="cs-user-filters">
        ...
        <div class="cs-candidate-specialisms">
            <div class="searchbox-heading"> <h5><?php echo esc_html__( 'specialisms', 'jobhunt' ) ?></h5> </div>
            <form method="GET" id="frm_specialisms_list" >
                ...
                <ul class="specialism_list">
					...
					if ( $specialisms != '' ) {
						...
						echo '<li><a  onclick="cs_listing_content_load();" href ="' . esc_url( cs_remove_qrystr_extra_var( $qrystr, 'specialisms' ) ) . '" >' . esc_html__( 'View all specialisms', 'jobhunt' ) . '</a></li><li>&nbsp;</li>';
					}
