                                    ...
                                    <?php if ( $specialisam_field_switch == 'yes' ) { ?>  
                                        ...
                                        if ( isset($atts['job_search_style']) and $atts['job_search_style'] == "modren" ) {
                                            ...
                                            <?php if ( $job_lable_switch == 'yes' && $atts['job_search_style'] != "fancy" ) { ?>
                                                ...
                                                ?>><?php esc_html_e('Specialism ', 'jobhunt') ?></span>
                                                  <?php } ?>
                                            <div class="select-dropdown">
                                                ...
                                                <?php if ( $job_lable_switch == 'yes' && $atts['job_search_style'] == "fancy" ) { ?>
                                                    ...
                                                    ?>><?php esc_html_e('Specialism ', 'jobhunt') ?></span>
                                                      ...
                                                      <?php
                                                      $specialisms_options = '';
                                                      $specialisms_options[''] = esc_html__('All specialisms', 'jobhunt');
                                                      ...
                                                      $cs_opt_array = array(
                                                          ...
                                                          'extra_atr' => 'data-placeholder="' . esc_html__("All specialisms", "jobhunt") . '"',
                                                      );
                                                    ...
                                                    ?>><?php esc_html_e("Filter by specialisms e.g. developer, designer", 'jobhunt') ?></label>
                                                    <?php } ?>
                                            </div>
                                        </div>
                                        <?php
