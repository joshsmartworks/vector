                                ...
                                <div class="social-media-info">
                                    <div class="social-input col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        $cs_opt_array = array(
                                            ...
                                            'std' => $cs_facebook,
                                            'desc' => '',
                                            'extra_atr' => ' placeholder="' . esc_html__('Facebook', 'jobhunt') . '" required="required"',
                                            'classes' => 'form-control',
                                            'hint_text' => '',
                                        );
                                    ...
                                    <div class="social-input col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        $cs_opt_array = array(
                                            ...
                                            'std' => $cs_twitter,
                                            'desc' => '',
                                            'extra_atr' => ' placeholder="' . esc_html__('Twitter', 'jobhunt') . '" required="required"',
                                            'classes' => 'form-control',
                                            'hint_text' => '',
                                        );
                                    ...
                                    <div class="social-input col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        $cs_opt_array = array(
                                            ...
                                            'std' => $cs_google_plus,
                                            'desc' => '',
                                            'extra_atr' => ' placeholder="' . esc_html__('Google Plus', 'jobhunt') . '" required="required"',
                                            'classes' => 'form-control',
                                            'hint_text' => '',
                                        );
                                        $cs_form_fields2->cs_form_text_render($cs_opt_array);
                                    ...
                                    <div class="social-input col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        $cs_opt_array = array(
                                            ...
                                            'std' => $cs_linkedin,
                                            'desc' => '',
                                            'extra_atr' => ' placeholder="' . esc_html__('Linkedin', 'jobhunt') . '" required="required"',
                                            'classes' => 'form-control',
                                            'hint_text' => '',
                                        );
                                ...
                                <div class="social-media-info">
                                    ...
                                    <div class="social-input col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        $cs_opt_array = array(
                                            ...
                                            'std' => $cs_website,
                                            'desc' => '',
                                            'extra_atr' => ' placeholder="' . esc_html__('Website', 'jobhunt') . '"  required="required"',
                                            'classes' => 'form-control',
                                            'hint_text' => '',
                                        );
