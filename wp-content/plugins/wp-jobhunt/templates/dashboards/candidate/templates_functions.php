                            ...
                            if ( $cs_page_id != '' && $cs_user_role_type != '' ) {
                                if ( $cs_user_role_type == 'candidate' ) {
                                    ...
                                    <ul class="dropdown-menu <?php echo esc_html($menu_cls); ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo esc_url(cs_users_profile_link($cs_page_id, 'shortlisted_jobs', $uid)); ?>" <?php echo force_balance_tags($data_toogle); ?>><i class="icon-heart11"></i> <?php esc_html_e('Shortlisted jobs', 'jobhunt'); ?></a>
                                        </li>
                                        <li>
