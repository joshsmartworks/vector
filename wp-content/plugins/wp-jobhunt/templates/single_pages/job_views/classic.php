                                    ...
                                    <div class="employer-company">
                                        ...
                                        <div class="cs-text">
                                            ...
                                            <ul class="detail-list">
                                                ...
                                                ?>
                                                <li>
                                                    <span><a data-target="#cs-msgbox-<?php echo absint($job_post->ID) ?>" data-toggle="modal" href="#"><i class="icon-mail"></i> <?php esc_html_e('Email', 'jobhunt'); ?></a></span>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="job-info">
                                                ...
                                                <ul class="posted-detail pull-left">
                                                    ...
                                                    ?>
                                                    <li><i class="icon-eye7"></i><?php esc_html_e("Views", "jobhunt"); ?><span><?php
                                            ...
                                            <div class="apply-job">
                                                <div class="cs-text">
                                                    ...
                                                    if (is_user_logged_in()) {
                                                        ...
                                                        ?>
                                                        <a href="javascript:void(0);" class="like applied_icon" onclick="trigger_func('#btn-header-main-login');">  <span><i class="icon-thumbsup"></i></span><?php esc_html_e('Apply Now', 'jobhunt') ?></a>
                                                        <?php
                                                    }
                                                    if (!is_user_logged_in()) {
                                                        ?>
