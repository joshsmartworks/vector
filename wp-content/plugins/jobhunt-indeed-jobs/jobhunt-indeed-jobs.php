...
//		$indeed_limit = 25;
//		$counter = intval($limit/$indeed_limit);
//		$left_val = $limit%$indeed_limit;
//		$indeed_jobs = array();
//		for( $i = 0; $i <= $counter; $i++ ){
//			if( $i == 0){
//				$api_args['start'] = $start;
//			}else{
//				$api_args['start'] = $start+$indeed_limit;
//				$start = $start+$indeed_limit;
//			}
//			if($i == $counter ){
//				$api_args['limit'] = $left_val;
//			}else{
//				$api_args['limit'] = $indeed_limit;
//			}
//			$jobs = Job_Hunt_Indeed_API::get_jobs_from_indeed( $api_args );
//			if ( isset( $jobs['error'] ) && $jobs['error'] != '' ) {
//				$indeed_jobs['error'] = $jobs['error'];
//				break;
//			}else{
//				$indeed_jobs = array_merge($indeed_jobs, $jobs);
//			}
//			
//		}
